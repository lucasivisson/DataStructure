...
int main() {
	...
	int result_consulta_lista_pos = consulta_lista_pos(li, pos, &dados_aluno);
	int result_consulta_lista_mat = consulta_lista_mat(li, pos, &dados_aluno);

	int result_remove_lista_inicio = remove_lista_inicio(li);
	int result_remove_lista_final = remove_lista_final(li);
	int result_remove_lista = remove_lista(li, mat);
